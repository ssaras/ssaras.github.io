...
!function(a) {
    a(".navscroll").on("click", function() {
        a("nav .navscroll").removeClass("active"),
        a(this).addClass("active");
        var i = a(this).data("idpage");
        a(this).hasClass("nav-works") ? dif_height = 70 : dif_height = 0,
...
!function(e, t, i, r) {
    ...
    o.prototype.init = function() {
        var t = this;
        l || s || (t.$player = e('<iframe frameborder="0" allowTransparency="true" style="background:transparent;" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>'),
        t.$player.attr("src", t.url),
        t.$element.append(t.$player),
        t.$player.css({
            visibility: "hidden"
        }),
        t.resize(),
        t.$element.bind("resize." + a, function() {
            t.resize()
        }),
        setTimeout(function() {
            t.$player.css({
    ...
    o.prototype.resize = function() {
        if (this.$player) {
            ...
            o.height < t && (o.height = t + t * i / 100,
            o.width = Math.floor(16 * t / 9),
            o.marginTop = -(t * (i / 2) / 100),
            o.marginLeft = -((o.width - e) / 2)),
            o.width += r,
            o.height += r,
            o.marginTop -= r / 2,
            o.marginLeft -= r / 2,
    ...
    e(i).ready(function() {
        e(t).bind("resize." + a, function() {
            for (var t, i = e[a].lookup.length, r = 0; i > r; r++)
                ...
                t.timer = setTimeout(t.resize(), 250))
        })
    })
...
/* Countdown */
!function(e) {
    e.fn.countdown = function(s) {
        function n() {
            eventDate = Date.parse(t.date) / 1e3,
...
$(function() {
    ...
    $(".knob").knob({
        ...
        draw: function() {
            if ("tron" == this.$.data("skin")) {
                var t, i = this.angle(this.cv), s = this.startAngle, h = this.startAngle, n = h + i, e = 1;
                return this.g.lineWidth = this.lineWidth,
                this.o.cursor && (h = n - .3) && (n += .3),
                this.o.displayPrevious && (t = this.startAngle + this.angle(this.v),
                this.o.cursor && (s = t - .3) && (t += .3),
                this.g.beginPath(),
    ...
    var t, i = 0, s = 0, h = 0, n = $("div.idir"), e = $("div.ival"), o = function() {
        h++,
        n.show().html("+").fadeOut(),
        e.html(h)
    }, r = function() {
