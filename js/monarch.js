(function($) {
    ...
    $(window).load(function() {
		...
		setTimeout(function() {
            $(".bottom-credits").removeClass("top-position");
        }, 2200);
        setTimeout(function() {
    ...
    $(document).ready(function() {
        ...
        $(".countdown-icon, .countdown-closer").on("click", function(e) {
            ...
            $(".countdown-modal").toggleClass("show");
        });
        ...
        $(".mobile-nav").on("click", function(n) {
            ...
            n.stopPropagation(), $("body").addClass("active-menu"), $(".menu-overlay").delay(100).fadeIn(400), $(".exit").hide(0).delay(300).fadeIn(800);
        }), $("html").on("click", function(n) {
            $("body").removeClass("active-menu"), $(".menu-overlay").fadeOut(300);
        }), $(".nav-container").on("mouseover", function($) {
            $.stopPropagation();
        }), $(".nav-container .exit").on("click", function(n) {
            n.preventDefault(), $("body").removeClass("active-menu"), $(".menu-overlay").fadeOut(300);
        }), $(".dropdown").on("click", function(n) {
            n.preventDefault(), $("body").removeClass("active-menu"), $(".menu-overlay").fadeOut(300);
		}), $(".nav-container .nav li").on("click", function(n) {	
            n.stopPropagation();
            var t = $(this).has(".dropdown").length;
            t ? (n.preventDefault(), $(this).find(".dropdown").hasClass("active") ? $(".dropdown").removeClass("active") : ($(".dropdown").removeClass("active"), $(this).find(
